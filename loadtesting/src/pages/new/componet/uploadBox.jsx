      ...
      <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-base font-medium text-gray-800 truncate">Select a file or drag and drop here</p>
            <p className="text-sm text-gray-400 truncate">lorem ipsum</p>
          </div>
        </div>
        <button className="border border-blue-500 text-blue-500 px-4 py-1 rounded hover:bg-blue-50 transition whitespace-nowrap flex-shrink-0 sm:ml-4">
          SELECT TARGET
        </button>
      </div>
